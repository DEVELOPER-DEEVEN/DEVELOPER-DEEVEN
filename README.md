...
- **🔬 CERN Research Fit**: Deep alignment with particle physics computing needs—signal processing, large dataset handling, distributed systems, and real-time analytics
...
**🔬 Open to CERN research collaboration. Let's advance particle physics together.**
